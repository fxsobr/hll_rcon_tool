...
ENDPOINT_PERMISSIONS: dict[Callable, list[str] | set[str] | str] = {
    ...
    rcon_api.edit_player_soldier: "api.can_edit_player_soldier",
    rcon_api.edit_player_account: "api.can_edit_player_account",
    ...
    rcon_api.remove_warmup_timer: "api.can_remove_warmup_timer",
    rcon_api.set_dynamic_weather_enabled: "api.can_set_dynamic_weather_enabled",
    ...
    rcon_api.edit_message_template: "api.can_edit_message_templates",
    ...
    rcon_api.get_message_templates: "api.can_view_message_templates",
    rcon_api.get_message_template_categories: "api.can_view_message_templates",
    rcon_api.get_message_template: "api.can_view_message_templates",
    rcon_api.get_all_message_templates: "api.can_view_message_templates",
    ...
    rcon_api.get_player_ids: "api.can_view_playerids",
...
RCON_ENDPOINT_HTTP_METHODS: dict[Callable, list[str]] = {
    ...
    rcon_api.edit_player_account: ["POST"],
    rcon_api.edit_player_soldier: ["POST"],
    ...
    rcon_api.set_map_rotation: ["POST"],
