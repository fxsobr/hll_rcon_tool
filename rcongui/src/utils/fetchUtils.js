...
export const cmd = {
  ...
  EDIT_PLAYER_ACCOUNT: (params) => requestFactory({ method: "POST", cmd: "edit_player_account", ...params }),
  EDIT_PLAYER_SOLDIER: (params) => requestFactory({ method: "POST", cmd: "edit_player_soldier", ...params }),
  ...
  GET_SERVER_NAME_CHANGE_CONFIG: (params) => requestFactory({ method: "GET", cmd: "get_server_name_change_config", ...params }),
  ...
  SET_SERVER_NAME_CHANGE_CONFIG: (params) => requestFactory({ method: "POST", cmd: "set_server_name_change_config", ...params }),
